<template>
  <AdminLayout>
    ...
    <PageHeader :title="'Editar articulo'" :breadcrumbs="breadcrumbs" backHref="/admin/help" />
...
const breadcrumbs = [
  ...
  { label: `Articulo #${props.article.id}`, active: true },
]

const submit = () => {
  form.put(`/admin/help/${props.article.id}`)
}
</script>
