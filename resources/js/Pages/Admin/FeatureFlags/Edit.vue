<template>
  <AdminLayout>
    <Head title="Editar flag" />

    <PageHeader :title="'Editar flag'" :breadcrumbs="breadcrumbs" backHref="/admin/feature-flags" />
...
const form = useForm({
  ...
  default_value: props.flag.default_value || '',
  is_active: props.flag.is_active,
})

const breadcrumbs = [
  { label: 'Feature Flags', href: '/admin/feature-flags' },
  { label: props.flag.key, active: true },
]

const submit = () => {
  form.put(`/admin/feature-flags/${props.flag.id}`)
}
</script>
