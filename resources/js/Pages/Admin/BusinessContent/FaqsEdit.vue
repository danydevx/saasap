  ...
  <AdminLayout>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
      <div>
        ...
        <h1 class="h4 mb-1 mt-1">Editar Pregunta Frecuente</h1>
      </div>
    </div>
...
const form = reactive({
  question: page.props.faq?.question || '',
  answer: page.props.faq?.answer || '',
  category_id: page.props.faq?.category_id || null,
  is_active: page.props.faq?.is_active ?? true,
  sort_order: page.props.faq?.sort_order || 0,
})

const submit = () => {
  router.put(`/admin/businesses/${business.value.id}/faqs/${page.props.faq.id}`, form, {
    onFinish: () => {
      sending.value = false
    },
  })
