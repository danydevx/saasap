<template>
  <AdminLayout>
    <Head title="Nueva Industria" />

    <PageHeader title="Nueva Industria" :breadcrumbs="breadcrumbs" backHref="/admin/industries" />
        ...
        <form @submit.prevent="submit">
          <div class="row g-3">
            ...
            <div class="col-12 col-md-6">
              <FieldText
                ...
                placeholder="barberia (auto-generado si vacio)"
              />
              <small class="text-muted">URL amigable. Se genera automaticamente si esta vacio.</small>
            </div>
            ...
            <div class="col-12 col-md-6">
              ...
              />
              <small class="text-muted d-block">Si esta desactivada, no aparecera en la lista de industrias.</small>
            </div>
            ...
            <div class="col-12">
              <FieldText
                ...
                placeholder="Describe esta industria..."
              />
            </div>
            ...
            <div class="col-12">
              ...
              <div class="card border-0 shadow-sm">
                <div class="card-body p-0">
                  <div
                    v-for="(mod, index) in availableModules"
                    :key="mod.id"
          ...
          <div class="col-12 d-flex gap-2 mt-4">
            <button type="submit" class="btn btn-primary" :disabled="sending">
              {{ sending ? 'Creando...' : 'Crear Industria' }}
            </button>
...
const submit = () => {
  sending.value = true
  router.post('/admin/industries', form, {
    onFinish: () => {
      sending.value = false
    },
  })
