<template>
  <AdminLayout>
    <Head title="Editar cupon" />

    <PageHeader :title="'Editar cupon'" :breadcrumbs="breadcrumbs" backHref="/admin/coupons" />
...
const form = useForm({
  ...
  applies_to_all_plans: !!props.coupon.applies_to_all_plans,
  plans: props.selectedPlans || [],
  stripe_coupon_id: props.coupon.stripe_coupon_id || '',
  stripe_promotion_code_id: props.coupon.stripe_promotion_code_id || '',
})
...
const breadcrumbs = [
  ...
  { label: `Cupon #${props.coupon.id}`, active: true },
]
