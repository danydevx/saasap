  ...
  <MemberLayout>
    ...
    >
      <template #description>
        <p class="text-muted mb-0">Selecciona un módulo para ver y gestionar su contenido.</p>
      </template>
    </PageHeader>
        ...
        <Link :href="mod.url" class="text-decoration-none">
          <div class="card border-0 shadow-sm h-100 module-card">
            <div class="card-body d-flex flex-column">
              ...
              <div class="mt-auto">
                <span class="badge bg-primary me-2">{{ mod.count }} {{ mod.count === 1 ? 'item' : 'items' }}</span>
